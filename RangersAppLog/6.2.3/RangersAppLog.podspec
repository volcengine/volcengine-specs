Pod::Spec.new do |s|
    ...
    # Download link is same as 6.2.4-rc.1. This is not a mistake. 
    s.source           = { :http => "https://sf3-ttcdn-tos.pstatp.com/obj/volcengine/RangersAppLog/6.2.4-rc.1/RangersAppLog.zip"}
