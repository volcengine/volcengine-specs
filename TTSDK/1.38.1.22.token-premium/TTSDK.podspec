  Pod::Spec.new do |spec|
    ...
    spec.name         = "TTSDK"
    spec.version      = "1.38.1.22.token-premium"
    ...
    spec.subspec 'LivePush-Base' do |subspec|
      ...
      subspec.vendored_libraries = [
        'TTSDK/LiveCore/**/*.a',
        "TTSDK/LiveStreamFramework/**/libLiveStreamFramework_{base,glbase,session,webrtc,_base_webrtc,ntp,audio-effect,disklog,effect,effect-wrapper,camera}_ios.a",
    ...
    spec.subspec 'Encode' do |subspec|
      subspec.subspec 'vc0' do |ss|
        ss.vendored_frameworks = 'TTSDK/libbytevc0enc/lib/bytevc0.framework'
      end
      subspec.subspec 'vc1' do |ss|
        ss.vendored_frameworks = 'TTSDK/libbytevc1enc/lib/bytevc1enc.framework'
      end
    end
