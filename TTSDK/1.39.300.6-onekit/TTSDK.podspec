  Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://byteplus-sdk.tos-ap-southeast-1.bytepluses.com/ttsdk/iOS/TTSDK-1.39.300.6-onekit.zip" }
    ...
    spec.subspec 'LivePush-Base' do |subspec|
      ...
      subspec.libraries = 'stdc++'
      subspec.dependency 'TTVideoEditor', '11.8.1.83-D' if ENV['TT_VIDEO_EDITOR_VERSION'].nil?
    ...
    spec.subspec 'LivePush-Base-VE' do |subspec|
      ...
      subspec.dependency 'TTSDK/Quic/Push'
      subspec.libraries = 'stdc++'
      subspec.dependency 'TTVideoEditor', '11.8.1.1-VE' if ENV['TT_VIDEO_EDITOR_VERSION'].nil?
