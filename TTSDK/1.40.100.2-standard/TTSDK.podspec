  Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://byteplus-sdk.tos-ap-southeast-1.bytepluses.com/ttsdk/iOS/TTSDK-1.40.100.2-standard.zip" }
    ...
    spec.subspec 'Player' do |subspec|
      ...
      lib_name = "#{class_name},MDLMediaDataLoader,TTTopSignature,PlaylistCacheModule,TTReachability,pcdn"
      subspec.vendored_libraries = [
        "TTSDK/{#{lib_name}}/**/*.a"
      ]
      subspec.dependency 'TTSDK/Core'
