  Pod::Spec.new do |spec|
    ...
    spec.name         = "TTSDK"
    spec.version      = "1.36.300.3-standard"
    ...
    spec.source       = { :http => "https://byteplus-sdk.tos-ap-southeast-1.bytepluses.com/ttsdk/iOS/TTSDK-1.36.300.3-standard.zip" }
    ...
    spec.subspec 'Core' do |subspec|
      ...
      unless $DoNotInstallApplogVersion == "6.13.0"
        ...
        subspec.dependency 'RangersAppLog/Host/SG', '~> 6.13.0'
      end
    ...
    spec.subspec 'Player-Lite' do |subspec|
      ...
      lib_name = "#{class_name},MDLMediaDataLoader,VCNVCloudNetwork,TTTopSignature,PlaylistCacheModule"
      subspec.vendored_libraries = [
        "TTSDK/{#{lib_name}}/**/*.a"
      ]
      subspec.dependency 'TTSDK/Core'
