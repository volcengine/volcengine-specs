  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.41.1.103-premium-noxc"
    ...
    spec.source       = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDK/1.41.1.103-premium-noxc/TTSDK-1.41.1.103-premium-noxc.zip" }
