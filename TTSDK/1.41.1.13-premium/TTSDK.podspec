  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.41.1.13-premium"
    ...
    spec.source       = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDK/1.41.1.13-premium/TTSDK-1.41.1.13-premium.zip" }
