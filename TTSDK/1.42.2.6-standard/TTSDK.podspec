  Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://lf6-vcloud-tos.pstatp.com/obj/cloud-common/ttsdk/iOS/#{spec.name}-#{spec.version}.zip" }
    ...
    spec.subspec 'VolcEngineRTC' do |rtc|
      rtc.vendored_frameworks = 'TTSDK/ByteRtcSDK/VolcEngineRTC.{framework,xcframework}'
