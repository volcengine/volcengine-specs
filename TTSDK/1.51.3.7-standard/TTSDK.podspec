  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.51.3.7-standard"
    ...
    spec.source       = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDK/1.51.3.7-standard/TTSDK-1.51.3.7-standard.zip" }
    ...
    spec.subspec 'VolcLog' do |subspec|
      ...
      subspec.source_files = [
        'TTSDK/VolcBaseLogiOS/ios/VolcLogSDK/Classes/*.h',
      ]
      subspec.public_header_files = [
        'TTSDK/VolcBaseLogiOS/ios/VolcLogSDK/Classes/*.h',
      ]
    ...
    spec.subspec 'PlayerCore' do |subspec|
      subspec.subspec 'Base' do |ss|
        ...
        ss.resources = [
          ...
          'TTSDK/TTPlayerSDK/TTPlayerSDK/Assets/ttplayer_sim.metallib',
        ]
    ...
    spec.subspec 'LivePlayer' do |subspec|
      subspec.subspec 'Base' do |ss|
        ...
        ss.weak_frameworks = [
          'MetalPerformanceShaders', 'AVFoundation', 'CoreMedia', 'AudioToolBox', 'VideoToolBox', 'CoreTelephony', 'SystemConfiguration', 'CoreML', 'AVKit'
        ]
        ss.libraries = 'stdc++'
        ss.dependency 'TTSDK/Core'
      ...
      subspec.subspec 'BMF' do |ss|
        ss.public_header_files = [
          ...
          'TTSDK/LivePlayer/business_modules/LivePlayer/Sources/Classes/VeLivePlayer+SuperResolution.h',
        ]
        ss.source_files = [
          'TTSDK/LivePlayer/business_modules/LivePlayer/Sources/VideoProcessing/**/*.h',
          'TTSDK/LivePlayer/business_modules/LivePlayer/Sources/VR/**/*.h',
    ...
    spec.subspec 'Player' do |subspec|
      ...
      subspec.exclude_files = [
        ...
        'TTSDK/TTVideoEngine/TTVideoEngine/Classes/Internal/TTVideoEngine+Internal.h',
      ...
      subspec.dependency 'TTSDK/VolcLog'
      subspec.weak_frameworks = ['MetricKit', 'CoreTelephony', 'AVKit']
    ...
    spec.subspec 'HeifCore' do |subspec|
      subspec.public_header_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/BDBase/HeifCloudConfig/Public/BDHeifCloudManagerConfig.h'
      ]
      subspec.source_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/BDBase/HeifCloudConfig/Public/BDHeifCloudManagerConfig.h'
      ]
      subspec.vendored_libraries = [
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_HeifCloudConfig_ios.a'
      ]
    ...
    spec.subspec 'ImageBase' do |subspec|
      subspec.public_header_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageMacro.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageError.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/BDBase/BaseConfig/**/*.h'
      ]
      subspec.source_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageMacro.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageError.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/BDBase/AuthorizationConfig/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/BDBase/BaseConfig/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageABTest.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageCommonDefine.h',
      ]
      subspec.vendored_libraries = [
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_AuthorizationConfig_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_BaseConfig_ios.a',
        # 'TTSDK/BDSword/ios-arch-iphone/*.a',
        'TTSDK/TTImageLicenseToB/ios-arch-iphone/*.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage__Core_HeifCore_ios.a',
      ]
    ...
    spec.subspec 'Image' do |subspec|
      subspec.public_header_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/Adapter/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/BDBase/BDBase/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/BDBase/CloudConfig/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Cache/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Crypto/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Manager/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Request/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Transform/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageDownloader.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageURLFactory.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Core/Public/Utils/BDWebImageUtil.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/BVC2/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/AVIF/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/BlurHash/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/ImageIO/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/WebP/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/DecoderBase/Public/BDImageView/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/DecoderBase/Public/BDImageDecoder/BDImageDecoderFactory/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/DecoderBase/Public/BDImageDecoder/BDImageDecoderConfig/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Download/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Extentions/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/LivePhoto/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Monitor/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/HEIC/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/DecoderBase/Public/BDImageDecoder/BDImageDecoder.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/DecoderBase/Public/BDImageDecoder/BDImageDecoderConfig/BDImageDecoderConfig.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Decoder/DecoderBase/Public/Util/BDImageDecoderUtil.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/TransformerPreprocessing/**/*.h',
      ]
      subspec.source_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/Adapter/**/*.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/BDBase/BDBase/**/*.h',
      ...
      subspec.vendored_libraries = [
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_BDSubBase_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_BlurHash_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_Cache_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_Chromium_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_CloudConfig_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_Core_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_DAV1D_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_DecoderBase_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_Download_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_Extentions_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_ImageIO_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_LivePhoto_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_Monitor_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_SDInterface_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_WebP_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_BVC2_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage__DecoderBase_HeifDecoder_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage__SubDecoder_HeifDecoder_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_TransformerPreprocessing_ios.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage__Core_HeifCore_ios.a',
        'TTSDK/BDSword/ios-arch-iphone/*.a',
    ...
    spec.subspec 'ImageHeifEncoder' do |subspec|
      subspec.public_header_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/Encoder/HEIC/BDImageHeicEncoder.h',
        'TTSDK/BDWebImage/BDWebImage/Classes/Encoder/HEIC/BDImageHeicEncoderMonitor.h'
      ]
      subspec.source_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/Encoder/**/*.h'
      ]
      subspec.vendored_libraries = [
        'TTSDK/libttheif_enc_ios/**/*.a',
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_SubEncoder_ios.a'
      ]
      subspec.dependency 'TTSDK/ImageBase'
    ...
    spec.subspec 'ImageExifEditor' do |subspec|
      subspec.public_header_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/ExifEditor/**/*.h',
      ]
      subspec.source_files = [
        'TTSDK/BDWebImage/BDWebImage/Classes/ExifEditor/**/*.h',
      ]
      subspec.vendored_libraries = [
        ...
        'TTSDK/BDWebImage/ios-arch-iphone/libBDWebImage_ExifEditor_ios.a'
      ]
    end
