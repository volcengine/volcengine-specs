  Pod::Spec.new do |spec|
    ...
    spec.name         = "TTSDK"
    spec.version      = "1.37.100.8-premium"
    ...
    spec.source       = { :http => "https://byteplus-sdk.tos-ap-southeast-1.bytepluses.com/ttsdk/iOS/TTSDK-1.37.100.8-premium.zip" }
    ...
    spec.subspec 'PlayerCore' do |subspec|
      subspec.public_header_files = [
        ...
        'TTSDK/TTPlayerSDK/TTPlayerSDK/TTPlayer/TTStreamInfo.h',
      ]
      subspec.source_files = [
        'TTSDK/TTPlayerSDK/TTPlayerSDK/TTPlayer/TTPlayerDef.h',
        'TTSDK/TTPlayerSDK/TTPlayerSDK/TTPlayer/TTAVPlayerLoadControlInterface.h',
