  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.44.1.6-standard"
    ...
    spec.source       = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDK/1.44.1.6-standard/TTSDK-1.44.1.6-standard.zip" }
    ...
    spec.subspec 'LivePull' do |subspec|
      subspec.dependency 'TTSDK/LivePull-Lite'
      subspec.dependency 'TTSDK/LivePull-BMF'
      subspec.dependency 'TTSDK/Quic/Pull'
      subspec.dependency 'TTSDK/Strategy/Pull'
      subspec.dependency 'TTSDK/LivePull-VolcLog'
    end
    ...
    spec.subspec 'Strategy' do |subspec|
      ...
      subspec.subspec 'Pull' do |ss|
        ...
        ss.dependency 'TTSDK/LivePull-Lite'
    ...
    spec.subspec 'Quic' do |subspec|
      ...
      subspec.subspec 'Pull' do |pull|
        ...
        pull.dependency 'TTSDK/LivePull-Lite'
      end
