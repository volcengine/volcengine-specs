  Pod::Spec.new do |spec|
    ...
    spec.name         = "TTSDK"
    spec.version      = "1.38.200.3-premium"
    ...
    spec.source       = { :http => "https://byteplus-sdk.tos-ap-southeast-1.bytepluses.com/ttsdk/iOS/TTSDK-1.38.200.3-premium.zip" }
    ...
    spec.subspec 'LivePush-Base' do |subspec|
      ...
      subspec.vendored_libraries = [
        'TTSDK/LiveCore/**/*.a',
        "TTSDK/LiveStreamFramework/**/libLiveStreamFramework_{base,glbase,session,webrtc,_base_webrtc,ntp,audio-effect,disklog,effect,effect-wrapper,camera,volc_base_log}_ios.a",
    ...
    spec.subspec 'Encode' do |subspec|
      ...
      subspec.subspec 'vc1' do |ss|
        ss.vendored_frameworks = 'TTSDK/libbytevc1enc/lib/h265enc.framework'
      end
    end
