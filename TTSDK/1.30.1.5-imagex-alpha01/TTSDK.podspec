  Pod::Spec.new do |spec|
    ...
    spec.name         = "TTSDK"
    spec.version      = "1.30.1.5-imagex-alpha01"
    ...
    spec.subspec 'Image' do |subspec|
      ...
      subspec.resources = [
        'TTSDK/BMFMods/BMFMods/resource/bmf_hydra/hydra.metallib'
      ]
      subspec.dependency 'TTSDK/Core'
      subspec.dependency 'TTSDK/TTNet'
      subspec.dependency 'TTSDK/Tools'
      # Third
      subspec.ios.frameworks = 'CFNetwork', 'MobileCoreServices', 'SystemConfiguration', 'JavaScriptCore', 'Accelerate', 'Metal', 'MetalKit', 'ModelIO', 'MetalPerformanceShaders'
