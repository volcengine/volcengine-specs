  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.41.1.102-premium-noxc"
    ...
    spec.source       = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDK/1.41.1.102-premium-noxc/TTSDK-1.41.1.102-premium-noxc.zip" }
