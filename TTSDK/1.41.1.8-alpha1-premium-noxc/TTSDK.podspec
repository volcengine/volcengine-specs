  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.41.1.8-alpha1-premium-noxc"
    ...
    spec.source       = { :http => "https://lf6-vcloud-tos.pstatp.com/obj/cloud-common/ttsdk/iOS/TTSDK-1.41.1.8-alpha1-premium-noxc.zip" }
