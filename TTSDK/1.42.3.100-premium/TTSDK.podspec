  Pod::Spec.new do |spec|
    ...
    spec.source       = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDK/1.42.3.100-premium/TTSDK-1.42.3.100-premium.zip" }
    ...
    spec.subspec 'VolcEngineRTC' do |rtc|
      rtc.vendored_frameworks = 'TTSDK/ByteRtcSDK/{VolcEngineRTC,BytePlusRTC}.{framework,xcframework}'
