  Pod::Spec.new do |spec|
    spec.name         = "TTSDK"
    spec.version      = "1.41.1.8-alpha1-premium"
    ...
    spec.source       = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDK/1.41.1.8-alpha1-premium/TTSDK-1.41.1.8-alpha1-premium.zip" }
    ...
    spec.subspec 'TTNet' do |subspec|
      ...
      subspec.dependency 'TTNetworkManager', '4.1.127.37'
      subspec.libraries = 'stdc++'
    end
    ...
    spec.subspec 'LivePush-Base' do |subspec|
      ...
      subspec.vendored_libraries = [
        'TTSDK/LiveCore/**/libLiveCore_{_glbase_rtcBase,camera,ktv,lite,liveStream,rtcBase,screenRecorder,tools}_ios.a',
    ...
    spec.subspec 'ScreenCapture' do |subspec|
      subspec.public_header_files = [
        'TTSDK/LiveCore/sources/VeLiveInterface/Classes/ScreenCapture/VeLivePusher+ScreenCapture.h'
      ]
      subspec.source_files = [
        'TTSDK/LiveCore/sources/VeLiveInterface/Classes/ScreenCapture/VeLivePusher+ScreenCapture.h'
      ]
      subspec.vendored_libraries = [
        "TTSDK/LiveCore/ios-arch-iphone/libLiveCore_ScreenCapture_ios.a",
      ]
