  Pod::Spec.new do |spec|
    ...
    spec.subspec 'Tools-VE' do |subspec| 
      ...
      subspec.dependency 'VEVideoKit/boringssl', '0.3.0'
      subspec.libraries = 'stdc++', 'z', 'xml2', 'iconv'
    end
    ...
    spec.subspec 'TTNet-VE' do |subspec| 
      ...
      subspec.dependency 'VEVideoKit/TTNetworkManager', '0.3.0'
    end
    ...
    spec.subspec 'TTFFmpeg-VE' do |subspec|
      ...
      subspec.dependency 'TTFFmpeg', '1.25.92.111-tob-dynamic-biz'
    ...
    spec.subspec 'PlayerCore-SR' do |subspec|
      ...
      subspec.vendored_libraries = [
        'TTSDK/TTPlayerSDK/TTPlayerSDK/**/*.a',
      ]
      subspec.vendored_frameworks = [
        'TTSDK/ffmpeg_dashdec_iOS/*.framework',
      ]
    ...
    spec.subspec 'LivePull-RTS-VE' do |subspec|
      ...
      subspec.dependency 'VolcEngineRTC-VE', '~> 3.39.153'
      subspec.dependency 'VEVideoKit/VolcEngineAudio', '0.3.0'
    end
