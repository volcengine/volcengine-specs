...
Pangrowth is an SDK that integrates novels, media, and live broadcasts.
  ...
  s.source           = { :http => 'https://sf3-fe-tos.pglstatp-toutiao.com/obj/pangle-empower/pangrowth/1.0.0/Pangrowth-1.0.0.zip' }
...
#  s.source_files = 'Pangrowth/Classes/**/*'
  ...
  s.subspec 'media' do |ss|
    ss.dependency 'PangrowthMedia', '2.7.0.1'
  end

  # 流媒体，TTVideoEngine动态库小包
  s.subspec 'media-dynamic-lite' do |ss|
    ss.dependency 'PangrowthMedia-dynamic-lite', '2.7.1.1'
  end
  
  # 流媒体，TTVideoEngine动态库全架构大包
  s.subspec 'media-dynamic' do |ss|
    ss.dependency 'PangrowthMedia-dynamic', '2.7.2.1'
  end
  
  # 流媒体+直播
  s.subspec 'media-live' do |ss|
    ss.dependency 'PangrowthMedia-live', '2.7.3.1'
