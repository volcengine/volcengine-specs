...
#  s.source_files = 'Pangrowth/Classes/**/*'
  ...
  s.subspec 'novel' do |ss|
    ss.dependency 'BDNovelOpenSDK', '3.4.0'
  end
  
  # 流媒体，包含了TTVideoEngine
  s.subspec 'media' do |ss|
    ss.dependency 'PangrowthMedia', '2.9.0.2'
  end
  
  # 流媒体，TTVideoEngine动态库全架构大包
  s.subspec 'media-dynamic' do |ss|
    ss.dependency 'PangrowthMedia-dynamic', '2.9.2.2'
  end
  
  # 流媒体+直播
  s.subspec 'media-live' do |ss|
    ss.dependency 'PangrowthMedia-live', '2.9.3.2'
    ss.dependency 'DouyinOpenSDK', '~> 4.0.0'
    ss.dependency 'PangrowthLiveSDK', '1.8.9.19'
    ss.dependency 'Pangrowth/live-3rd-dep'
    ss.dependency 'VolMetaSecML', '4.3.4'
  end
