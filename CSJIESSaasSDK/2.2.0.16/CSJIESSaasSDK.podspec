Pod::Spec.new do |s|
  ...
  s.subspec 'Saas' do |ss|
    ...
    ss.dependency "CSJIESSaasSDK/DYLiveSDKHupu"
  ...
  # 直播核心SDK
  s.subspec 'DYLiveSDKHupu' do |ss|
    ss.vendored_frameworks = "Frameworks/DYLiveSDK-hupu.framework"
    ss.preserve_paths = "Frameworks/DYLiveSDK-hupu.framework"
    ss.resources = [
      "Frameworks/DYLiveSDK-hupu.framework/*.bundle",
      "Frameworks/DYLiveSDK-hupu.framework/Headers/PrivacyInfo.xcprivacy"
    ]
  end
