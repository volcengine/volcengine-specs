...
TODO: Add long description of the pod here.
  ...
  s.subspec 'OneKit' do |o|
    o.vendored_libraries = 'VEH5Kit/Classes/OneKit/**/*.a'
    o.source_files = 'VEH5Kit/Classes/OneKit/**/*.{h,m}'
    o.public_header_files = 'VEH5Kit/Classes/OneKit/Tasks/*.h'
    o.dependency 'OneKit/StartUp'
  end

  s.default_subspecs =  'Core', 'JSBridge', 'WebView', 'OneKit'
end
