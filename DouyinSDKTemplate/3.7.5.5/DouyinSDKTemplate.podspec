...
spec.subspec "ToB" do |tob|
    # ToB 公用依赖
    # 此处的依赖实际是需要增加版本号的
    tob.dependency "DouyinSDK/Init", '3.7.5.3'
    tob.dependency "DouyinSDK/Services/Security", '3.7.5.3'
    tob.dependency "DouyinSDK/Services/APM", '3.7.5.3'
    tob.dependency "DouyinSDK/Services/AppLog", '3.7.5.3'
    tob.dependency "DouyinSDK/Services/SDKSetting", '3.7.5.3'
    tob.dependency "DouyinSDK/Services/Auth", '3.7.5.3'
    ...
    tob.dependency "AwemeOpenSDK/ToBBuiltIn", '= 3.7.5.5'

    tob.subspec "Media" do |media|
        media.dependency 'MetaAD', '1.0.0.7'
        # lottie 库不能到 3.x
        media.dependency 'lottie-ios', '2.5.3'
        media.dependency "AwemeOpenSDK/TemplateToB/Feed", '= 3.7.5.5'
        media.dependency "AwemeOpenSDK/TemplateToB/Series", '= 3.7.5.5'
        media.dependency "AwemeOpenSDK/TemplateToB/Optional", '= 3.7.5.5'
    ...
    tob.subspec "Series" do |series|
        series.dependency "AwemeOpenSDK/TemplateToB/Series", '= 3.7.5.5'
        # TTSDKFramework 接入方式适配
        unless $DouyinSDKUseTTSDKFramework == true
    ...
    tob.subspec "LiteMedia" do |lite_media|
        lite_media.dependency "AwemeOpenSDK/TemplateToB/Feed", '= 3.7.5.5'
        # TTSDKFramework 接入方式适配
        unless $DouyinSDKUseTTSDKFramework == true
