...
spec.subspec "ToB" do |tob|
    # ToB 公用依赖
    # 此处的依赖实际是需要增加版本号的
    tob.dependency "DouyinSDK/Init", '3.5.3.1'
    tob.dependency "DouyinSDK/Services/Security", '3.5.3.1'
    tob.dependency "DouyinSDK/Services/APM", '3.5.3.1'
    tob.dependency "DouyinSDK/Services/AppLog", '3.5.3.1'
    tob.dependency "DouyinSDK/Services/SDKSetting", '3.5.3.1'
    tob.dependency "DouyinSDK/Services/Auth", '3.5.3.1'
    ...
    tob.subspec "Media" do |media|
        ...
        media.dependency "AwemeOpenSDK/TemplateToB", '= 3.5.3.1'
