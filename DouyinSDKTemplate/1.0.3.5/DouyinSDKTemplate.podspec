...
Pod::Spec.new do |spec|
    ...
    spec.subspec "ToB" do |tob|
        # ToB 公用依赖
        # 此处的依赖实际是需要增加版本号的
        tob.dependency "DouyinSDK/Init", "1.0.3.5"
        ...
        tob.subspec "Media" do |media|
            media.default_subspecs = "TTSDK"
            media.dependency "AwemeOpenSDK/Template/ToB", "1.0.3.5"

            media.subspec "TTSDKFramework" do |ttsdkframework|
              ttsdkframework.dependency "TTSDKFramework/Video"
              ttsdkframework.dependency "TTSDKFramework/Image"
              ttsdkframework.dependency 'MetaAD', '1.0.0.1-dynamicttsdk'
            end
    
            media.subspec "TTSDK" do |ttsdk|
              ttsdk.dependency "TTSDK/Player"
              ttsdk.dependency "TTSDK/Image"
              ttsdk.dependency 'MetaAD', '1.0.0.1'
            end
        end
