...
Pod::Spec.new do |spec|
  ...
  spec.version      = "3.3.9.1-csj-framework"
...
spec.subspec "ToB" do |tob|
    # ToB 公用依赖
    # 此处的依赖实际是需要增加版本号的
    tob.dependency "DouyinSDK/Init", '3.3.9.1'
    ...
    tob.subspec "Media" do |media|
        media.dependency 'MetaAD', '1.0.0.5-frame-test'
        media.dependency "AwemeOpenSDK/TemplateToB", '= 3.3.9.1'
