Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source = {"http"=>"https://sf3-ttcdn-tos.pstatp.com/obj/volcengine/TTVideoEditor/11.3.0.8-D/TTVideoEditor.zip"}
...
s.pod_target_xcconfig = { "VALID_ARCHS" => "armv7 arm64" }
 ...
 # shell_commit=a07431bc0672c8eea7424dde8b3b85a73af1eb9e
