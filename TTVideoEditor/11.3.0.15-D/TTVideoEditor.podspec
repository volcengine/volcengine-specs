Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source = {"http"=>"https://sf3-ttcdn-tos.pstatp.com/obj/volcengine/TTVideoEditor/11.3.0.15-D/TTVideoEditor.zip"}
...
s.pod_target_xcconfig = { "VALID_ARCHS" => "armv7 arm64" }
 ...
 # shell_commit=6e6d4660fe7120d7a01efa294988e500cbeb868c
