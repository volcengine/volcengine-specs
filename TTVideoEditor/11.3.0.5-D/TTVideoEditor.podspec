Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source = {"http"=>"https://sf3-ttcdn-tos.pstatp.com/obj/volcengine/TTVideoEditor/11.3.0.5-D/TTVideoEditor.zip"}
...
s.pod_target_xcconfig = { "VALID_ARCHS" => "armv7 arm64" }
 ...
 # shell_commit=864bf61cec4ebc345437fb25df08ce3af10a8d38
