Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source = {"http"=>"https://sf3-ttcdn-tos.pstatp.com/obj/volcengine/TTVideoEditor/11.8.1.4-D/TTVideoEditor.zip"}
...
s.pod_target_xcconfig = { "VALID_ARCHS" => "armv7 arm64" }
 ...
 # shell_commit=dcc48f2a6d8de2c08d84e697376912c643185ea7
