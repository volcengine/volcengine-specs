Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  s.source = {"http"=>"https://sf3-ttcdn-tos.pstatp.com/obj/volcengine/TTVideoEditor/10.6.0.1-D/TTVideoEditor.zip"}
...
s.pod_target_xcconfig = { "VALID_ARCHS" => "armv7 arm64" }
 ...
 # shell_commit=b5c0656c27676690a5fa94b6411bb4e41c3cea10
