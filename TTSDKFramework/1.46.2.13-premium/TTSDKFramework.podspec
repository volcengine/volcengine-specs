Pod::Spec.new do |spec|
  ...
  spec.version = "1.46.2.13-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.46.2.13-premium/TTSDKFramework-1.46.2.13-premium-ta.zip", :type => :zip }
