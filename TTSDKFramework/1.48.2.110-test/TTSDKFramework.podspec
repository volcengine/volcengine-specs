Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.2.110-test/TTSDKFramework-1.48.2.110-test-ta.zip", :type => :zip }
