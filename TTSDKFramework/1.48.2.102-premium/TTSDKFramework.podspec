Pod::Spec.new do |spec|
  ...
  spec.version = "1.48.2.102-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.2.102-premium/TTSDKFramework-1.48.2.102-premium-ta.zip", :type => :zip }
