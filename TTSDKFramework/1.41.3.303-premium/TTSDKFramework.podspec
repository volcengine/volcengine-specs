Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.3.303-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.3.303-premium/TTSDKFramework-1.41.3.303-premium-ta.zip", :type => :zip }
  ...
  spec.subspec 'Core' do |subspec|
    ...
    unless $DoNotInstallApplogVersion == "6.16.2"
      subspec.dependency 'RangersAppLog/Core', '6.16.9'
      subspec.dependency 'RangersAppLog/Host/CN', '6.16.9'
    end
