Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.49.1.7-premium/TTSDKFramework-1.49.1.7-premium-ta.zip", :type => :zip }
