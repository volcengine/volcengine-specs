Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.1.101-premium-alpha01/TTSDKFramework-1.41.1.101-premium-alpha01-ta.zip", :type => :zip }
