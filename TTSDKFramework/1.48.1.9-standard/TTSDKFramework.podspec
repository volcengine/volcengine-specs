Pod::Spec.new do |spec|
  ...
  spec.version = "1.48.1.9-standard"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.1.9-standard/TTSDKFramework-1.48.1.9-standard-ta.zip", :type => :zip }
