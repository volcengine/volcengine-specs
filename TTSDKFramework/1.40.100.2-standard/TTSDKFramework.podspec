Pod::Spec.new do |spec|
  ...
  spec.version = "1.40.100.2-standard"
  ...
  spec.source = { :http => "https://byteplus-sdk.tos-ap-southeast-1.bytepluses.com/ttsdk/iOS/TTSDKFramework-1.40.100.2-standard-ta.zip", :type => :zip }
  ...
  spec.subspec "Video" do |subspec|
    ...
    subspec.weak_frameworks = 'CoreGraphics', 'CoreTelephony', 'VideoToolbox', 'AudioToolbox', 'CoreMedia', 'Metal', 'MetalKit', 'MetalPerformanceShaders', 'CoreFoundation', 'CoreVideo', 'IOSurface', 'QuartzCore', 'CoreImage', 'OpenGLES', 'MetricKit', 'Photos', 'UniformTypeIdentifiers', 'Accelerate'
  end
  ...
  spec.subspec 'Encode' do |subspec|
    subspec.subspec 'vc0' do |ss|
      ss.vendored_frameworks = 'h264.framework'
    end
    subspec.subspec 'vc1' do |ss|
      ss.vendored_frameworks = 'h265enc.xcframework'
    end
  end
