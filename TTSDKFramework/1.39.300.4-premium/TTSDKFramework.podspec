Pod::Spec.new do |spec|
  ...
  spec.version = "1.39.300.4-premium"
  ...
  spec.source = { :http => "https://byteplus-sdk.tos-ap-southeast-1.bytepluses.com/ttsdk/iOS/TTSDKFramework-1.39.300.4-premium-ta.zip", :type => :zip }
