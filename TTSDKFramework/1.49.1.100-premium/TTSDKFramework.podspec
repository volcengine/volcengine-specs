Pod::Spec.new do |spec|
  ...
  spec.version = "1.49.1.100-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.49.1.100-premium/TTSDKFramework-1.49.1.100-premium-ta.zip", :type => :zip }
