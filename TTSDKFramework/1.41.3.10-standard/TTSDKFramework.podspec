Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.3.10-standard"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.3.10-standard/TTSDKFramework-1.41.3.10-standard-ta.zip", :type => :zip }
