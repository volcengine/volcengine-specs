Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.3.500-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.3.500-premium/TTSDKFramework-1.41.3.500-premium-ta.zip", :type => :zip }
