Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.3.12-premium-test3"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.3.12-premium-test3/TTSDKFramework-1.41.3.12-premium-test3-ta.zip", :type => :zip }
