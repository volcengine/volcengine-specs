Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.1.12-premium/TTSDKFramework-1.41.1.12-premium-ta.zip", :type => :zip }
  ...
  spec.subspec 'LibYUV' do |subspec| 
    subspec.source_files = "TTSDKFramework/TTSDKLibYUV/Classes/Headers/*.h"
    subspec.public_header_files = "TTSDKFramework/TTSDKLibYUV/Classes/Headers/*.h"
    subspec.vendored_frameworks = "TTSDKFramework/TTSDKLibYUV/*.{xcframework,framework}"
  end
  ...
  spec.subspec 'Image' do |subspec|
    ...
    subspec.dependency 'TTSDKFramework/LibYUV'
    subspec.dependency 'TTSDKFramework/Core'
    subspec.dependency 'TTSDKFramework/TTNet'
    subspec.dependency 'TTSDKFramework/Tools'
    # Third
