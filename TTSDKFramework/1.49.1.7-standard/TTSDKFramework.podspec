Pod::Spec.new do |spec|
  ...
  spec.version = "1.49.1.7-standard"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.49.1.7-standard/TTSDKFramework-1.49.1.7-standard-ta.zip", :type => :zip }
