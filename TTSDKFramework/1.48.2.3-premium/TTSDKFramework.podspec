Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.2.3-premium/TTSDKFramework-1.48.2.3-premium-ta.zip", :type => :zip }
