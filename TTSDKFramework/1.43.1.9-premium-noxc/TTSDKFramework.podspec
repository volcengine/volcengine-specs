Pod::Spec.new do |spec|
  ...
  spec.version = "1.43.1.9-premium-noxc"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.43.1.9-premium-noxc/TTSDKFramework-1.43.1.9-premium-noxc-ta.zip", :type => :zip }
