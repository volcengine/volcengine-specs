Pod::Spec.new do |spec|
  ...
  spec.version = "1.45.3.102-standard"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.45.3.102-standard/TTSDKFramework-1.45.3.102-standard-ta.zip", :type => :zip }
