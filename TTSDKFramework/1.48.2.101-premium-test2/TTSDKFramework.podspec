Pod::Spec.new do |spec|
  ...
  spec.version = "1.48.2.101-premium-test2"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.2.101-premium-test2/TTSDKFramework-1.48.2.101-premium-test2-ta.zip", :type => :zip }
