Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.3.105-test100"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.42.3.105-test100/TTSDKFramework-1.42.3.105-test100-ta.zip", :type => :zip }
