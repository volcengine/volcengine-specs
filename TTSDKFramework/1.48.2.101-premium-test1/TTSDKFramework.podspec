Pod::Spec.new do |spec|
  ...
  spec.version = "1.48.2.101-premium-test1"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.2.101-premium-test1/TTSDKFramework-1.48.2.101-premium-test1-ta.zip", :type => :zip }
