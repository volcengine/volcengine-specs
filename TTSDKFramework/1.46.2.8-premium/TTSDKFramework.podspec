Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.46.2.8-premium/TTSDKFramework-1.46.2.8-premium-ta.zip", :type => :zip }
