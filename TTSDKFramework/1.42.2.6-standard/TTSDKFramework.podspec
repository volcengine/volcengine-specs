Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.2.6-standard"
  ...
  spec.source = { :http => "https://lf6-vcloud-tos.pstatp.com/obj/cloud-common/ttsdk/iOS/#{spec.name}-#{spec.version}-ta.zip", :type => :zip }
  ...
  spec.subspec 'LiveBase' do |subspec|
    ...
    subspec.dependency 'TTSDKFramework/Quic/Core'
    subspec.dependency 'TTSDKFramework/Reachability'
    subspec.dependency 'TTSDKFramework/HttpDNS'
    subspec.libraries = 'stdc++'
  end
  ...
  spec.subspec 'VolcEngineRTC' do |subspec|
    subspec.vendored_frameworks = "TTSDKFramework/TTSDKVolcEngineRTC/*.{xcframework,framework}"
    subspec.dependency 'TTSDKFramework/RTCFFmpeg'
    subspec.dependency 'TTSDKFramework/Encode/h265'
    subspec.dependency 'TTSDKFramework/ByteAudio'
  end
