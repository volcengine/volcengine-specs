Pod::Spec.new do |spec|
  ...
  spec.version = "1.47.1.200-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.47.1.200-premium/TTSDKFramework-1.47.1.200-premium-ta.zip", :type => :zip }
