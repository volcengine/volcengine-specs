Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.50.1.1-test34/TTSDKFramework-1.50.1.1-test34-ta.zip", :type => :zip }
  ...
  spec.subspec 'TTNet' do |subspec|
    ...
    subspec.dependency 'TTNetworkManager', '4.2.210.21'
    subspec.libraries = 'stdc++'
  end
