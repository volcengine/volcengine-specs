Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.2.102-test1/TTSDKFramework-1.48.2.102-test1-ta.zip", :type => :zip }
