Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.45.3.103-test2/TTSDKFramework-1.45.3.103-test2-ta.zip", :type => :zip }
