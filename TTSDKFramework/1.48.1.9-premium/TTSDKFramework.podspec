Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.1.9-premium/TTSDKFramework-1.48.1.9-premium-ta.zip", :type => :zip }
