Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.3.105-test102"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.42.3.105-test102/TTSDKFramework-1.42.3.105-test102-ta.zip", :type => :zip }
