Pod::Spec.new do |spec|
  ...
  spec.version = "1.48.2.3-noxc-test0319-1-noxc"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.48.2.3-noxc-test0319-1-noxc/TTSDKFramework-1.48.2.3-noxc-test0319-1-noxc-ta.zip", :type => :zip }
