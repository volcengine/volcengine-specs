Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.3.12-premium-test5/TTSDKFramework-1.41.3.12-premium-test5-ta.zip", :type => :zip }
