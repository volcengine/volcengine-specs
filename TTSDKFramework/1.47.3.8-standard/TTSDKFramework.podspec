Pod::Spec.new do |spec|
  ...
  spec.version = "1.47.3.8-standard"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.47.3.8-standard/TTSDKFramework-1.47.3.8-standard-ta.zip", :type => :zip }
