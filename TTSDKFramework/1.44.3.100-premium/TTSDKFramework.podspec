Pod::Spec.new do |spec|
  ...
  spec.version = "1.44.3.100-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.44.3.100-premium/TTSDKFramework-1.44.3.100-premium-ta.zip", :type => :zip }
