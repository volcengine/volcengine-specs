Pod::Spec.new do |spec|
  ...
  spec.version = "1.47.3.4-standard"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.47.3.4-standard/TTSDKFramework-1.47.3.4-standard-ta.zip", :type => :zip }
