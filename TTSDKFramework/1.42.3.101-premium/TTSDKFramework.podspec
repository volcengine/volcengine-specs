Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.3.101-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.42.3.101-premium/TTSDKFramework-1.42.3.101-premium-ta.zip", :type => :zip }
