Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.47.3.4-premium/TTSDKFramework-1.47.3.4-premium-ta.zip", :type => :zip }
