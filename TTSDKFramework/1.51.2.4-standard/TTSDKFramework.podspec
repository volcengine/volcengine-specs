Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.51.2.4-standard/TTSDKFramework-1.51.2.4-standard-ta.zip", :type => :zip }
  ...
  spec.subspec 'LivePlayer' do |subspec|
    subspec.subspec 'Base' do |ss|
      ...
      ss.weak_frameworks = ['MetalPerformanceShaders', 'AVFoundation', 'CoreMedia', 'AudioToolBox', 'VideoToolBox', 'CoreTelephony', 'SystemConfiguration', 'CoreML', 'AVKit']
      ss.libraries = 'stdc++'
    end
