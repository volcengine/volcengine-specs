Pod::Spec.new do |spec|
  ...
  spec.version = "1.39.300.6-onekit"
  ...
  spec.source = { :http => "https://byteplus-sdk.tos-ap-southeast-1.bytepluses.com/ttsdk/iOS/TTSDKFramework-1.39.300.6-onekit-ta.zip", :type => :zip }
