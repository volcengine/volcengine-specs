Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.3.105-test105"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.42.3.105-test105/TTSDKFramework-1.42.3.105-test105-ta.zip", :type => :zip }
