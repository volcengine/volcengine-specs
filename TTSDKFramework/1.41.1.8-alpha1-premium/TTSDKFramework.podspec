Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.1.8-alpha1-premium/TTSDKFramework-1.41.1.8-alpha1-premium-ta.zip", :type => :zip }
