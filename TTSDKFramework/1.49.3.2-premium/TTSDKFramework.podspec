Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.49.3.2-premium/TTSDKFramework-1.49.3.2-premium-ta.zip", :type => :zip }
