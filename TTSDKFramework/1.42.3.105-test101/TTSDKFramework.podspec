Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.3.105-test101"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.42.3.105-test101/TTSDKFramework-1.42.3.105-test101-ta.zip", :type => :zip }
