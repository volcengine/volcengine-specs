Pod::Spec.new do |spec|
  ...
  spec.version = "1.44.3.7-standard"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.44.3.7-standard/TTSDKFramework-1.44.3.7-standard-ta.zip", :type => :zip }
