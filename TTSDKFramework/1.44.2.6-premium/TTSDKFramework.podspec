Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.44.2.6-premium/TTSDKFramework-1.44.2.6-premium-ta.zip", :type => :zip }
