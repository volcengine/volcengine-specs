Pod::Spec.new do |spec|
  ...
  spec.version = "1.49.3.2-standard"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.49.3.2-standard/TTSDKFramework-1.49.3.2-standard-ta.zip", :type => :zip }
