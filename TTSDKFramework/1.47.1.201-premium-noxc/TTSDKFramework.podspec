Pod::Spec.new do |spec|
  ...
  spec.version = "1.47.1.201-premium-noxc"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.47.1.201-premium-noxc/TTSDKFramework-1.47.1.201-premium-noxc-ta.zip", :type => :zip }
