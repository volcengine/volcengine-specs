Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.47.3.5-premium/TTSDKFramework-1.47.3.5-premium-ta.zip", :type => :zip }
