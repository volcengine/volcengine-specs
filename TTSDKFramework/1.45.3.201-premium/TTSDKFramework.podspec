Pod::Spec.new do |spec|
  ...
  spec.version = "1.45.3.201-premium"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.45.3.201-premium/TTSDKFramework-1.45.3.201-premium-ta.zip", :type => :zip }
  ...
  spec.subspec 'TTFFmpeg' do |subspec|
    ...
    subspec.subspec 'Normal' do |ss|
      ...
      ss.dependency 'TTSDKFramework/TTFFmpeg/Base'
    end
