Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.42.3.7-premium/TTSDKFramework-1.42.3.7-premium-ta.zip", :type => :zip }
