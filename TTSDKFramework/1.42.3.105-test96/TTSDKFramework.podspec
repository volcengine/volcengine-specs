Pod::Spec.new do |spec|
  ...
  spec.version = "1.42.3.105-test96"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.42.3.105-test96/TTSDKFramework-1.42.3.105-test96-ta.zip", :type => :zip }
