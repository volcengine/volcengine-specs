Pod::Spec.new do |spec|
  ...
  spec.version = "1.41.3.202-imagex"
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.3.202-imagex/TTSDKFramework-1.41.3.202-imagex-ta.zip", :type => :zip }
