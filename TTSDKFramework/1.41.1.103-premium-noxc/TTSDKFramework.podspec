Pod::Spec.new do |spec|
  ...
  spec.source = { :http => "https://hstob-cdn-tos.volccdn.com/volcengine/TTSDKFramework/1.41.1.103-premium-noxc/TTSDKFramework-1.41.1.103-premium-noxc-ta.zip", :type => :zip }
