...
Pod::Spec.new do |s|
  ...
  s.dependency 'OneKit/boringssl', '1.3.7-rc.2-prefixed'
  s.dependency 'OneKit/BaseKit', '1.3.7-rc.2-prefixed'
  s.dependency 'OneKit/StartUp', '1.3.7-rc.2-prefixed'
