...
s.version      = "10.6.10.2-VE"
s.summary      = "EffectSDK_iOS"
s.description      = <<-DESC
A cross platform render effect library for livestream and short vedio.
DESC

s.author       = { "VolcanoEngine Service" => "service@volcengine.com" }
...
s.subspec 'Core' do |core|
    ...
    core.frameworks = 'AVFoundation', 'CoreMedia', 'VideoToolbox', 'Accelerate', 'AudioToolbox', 'Foundation', 'GLKit', 'imageIO', 'IOKit', 'JavaScriptCore'
    core.weak_frameworks = 'CoreHaptics'
    core.libraries = 'z','c++'
end

s.subspec 'FullModel' do |full|
    full.resource = 'libEffectSDK/Resources/EffectSDKResources.bundle'
    full.dependency 'Core'
end

s.subspec 'PartModel' do |part|
    part.resource = 'libEffectSDK/Resources/part/EffectSDKResources.bundle'
    part.dependency 'Core'
end
