Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
    ...
    core.dependency 'OneKit/BDMantle', '>=1.1.0-rc.7'
  end
  ...
  s.subspec 'Engines' do |engines|
    ...
    engines.subspec 'TTBridgeUnifyAdapter' do |adapter|
      adapter.subspec 'CoreEngine' do |core|
        ...
        core.public_header_files = 'BDXBridgeKitToB/Classes/Engines/TTBridgeUnifyAdapter/**/*.h'
        core.source_files = 'BDXBridgeKitToB/Classes/Engines/TTBridgeUnifyAdapter/**/*.h'
  ...
  s.subspec 'Methods' do |methods|
    ...
    methods.subspec 'Event' do |event|
      ...
      event.public_header_files = 'BDXBridgeKitToB/Classes/Methods/Event/*.h'
      event.source_files = 'BDXBridgeKitToB/Classes/Methods/Event/*.h'
      event.private_header_files = 'BDXBridgeKitToB/Classes/Methods/Event/*+Internal.h'
    end
    
    methods.subspec 'System' do |system|
      system.dependency 'OneKit/BaseKit'
      system.dependency 'BDXBridgeKitToB/Methods/Event'
      system.vendored_libraries = 'BDXBridgeKitToB/Classes/Methods/System/*.a'
      system.frameworks = 'MessageUI', 'EventKit', 'AudioToolbox', 'Photos', 'AVFoundation', ''
    end
    ...
    methods.subspec 'Media' do |media|
      media.dependency 'OneKit/BaseKit'
      ...
      media.frameworks = 'MobileCoreServices'
    end
    ...
    methods.subspec 'Open' do |open|
      ...
      open.dependency 'OneKit/BaseKit'
    end
    ...
    methods.subspec 'ScreenShot' do |screenShot|
      ...
      screenShot.frameworks = 'Photos', 'WebKit'
    end
  end
