...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.license          = { :type => 'MIT', :file => 'metasec_ml/LICENSE' }
  s.author           = { 'huoxk'        => 'huoxinkai@bytedance.com',
                         'wangwenchong' => 'wangwenchong@bytedance.com' }
  s.source           = { :http => 'https://sf3-ttcdn-tos.pstatp.com/obj/volcengine/metasec_ml/3.5.11/metasec_ml.zip'}
  ...
  s.public_header_files = 'metasec_ml/*.h'
  s.vendored_libraries = 'metasec_ml/libmetasec_ml.a'
