...
Pod::Spec.new do |s|
  ...
  s.subspec 'Core' do |core|
      core.public_header_files = 'BDPreloadSDKToB/Core/*.h'
      core.source_files = 'BDPreloadSDKToB/Core/*.h'
      core.vendored_libraries = 'BDPreloadSDKToB/Core/*.a'
      core.frameworks = 'Foundation','UIKit'
      core.dependency 'OneKit/Reachability'
  end

  s.subspec 'WebView' do |webview|
      webview.public_header_files = 'BDPreloadSDKToB/WebView/*.h'
      webview.source_files = 'BDPreloadSDKToB/WebView/*.h'
      webview.vendored_libraries = 'BDPreloadSDKToB/WebView/*.a'
